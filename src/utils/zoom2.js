...
import { ref } from 'vue'
const atop = ref(50)
const pinchTop = ref(0)
const aheight = ref(0)
const ascale = ref(1)
const tMatrix = ref([])
export { atop, pinchTop, ascale, tMatrix }
export function hammerIt(el) {
  ...
  aheight.value = el.getBoundingClientRect().height
  ...
  function onPinch(ev) {
    ...
    atop.value = el.getBoundingClientRect().top
    atop.value = tMatrix.value[5]
    ascale.value = nowScale
